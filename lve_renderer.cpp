...
namespace lve {
    ...
    void LveRenderer::endFrame() {
        assert(isFrameStarted && "Cannot call endFram while frame is not in progress");
    ...
    void LveRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer) {
        ...
        assert(commandBuffer == getCurrentCommandBuffer() && "Cannot beging render pass on command buffer from a different frame");
