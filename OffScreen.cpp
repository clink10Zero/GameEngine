...
namespace lve {
    ...
    //euh j'ai copier coller donc me demande pas =)
    OffScreen::OffScreen(LveDevice& device, VkDescriptorSetLayout globalSetLayout) : m_Device{ device }, DescriptorSetLayout{ globalSetLayout } {
        pass.width = 1280;
        pass.height = 720;
